...
class ZoneoutLSTMCell(tf.nn.rnn_cell.RNNCell):
    def __init__(self, num_units, is_training, zoneout_factor_cell=0., zoneout_factor_output=0., state_is_tuple=True, num_proj=None):
        ...
        self._cell = tf.nn.rnn_cell.LSTMCell(num_units, state_is_tuple=state_is_tuple, num_proj=num_proj)
